    ...
    <%@ include file="../resources/template/header.jsp" %>
      <div id="container">
        <div id="nav_container">
          ...
          <form action="boardReplyAction" method="post" onsubmit="return boardWriteValidate();">
            <input type="hidden" value="${sessionScope.loginMember.id}" name="id">
            <input type="hidden" value="${parentArticle.articleno}" name="parentArticleno">
            <input type="hidden" value="${parentArticle.ref}" name="parentRef">
            <input type="hidden" value="${parentArticle.restep}" name="parentRestep">
            <input type="hidden" value="${parentArticle.relevel}" name="parentRelevel">
